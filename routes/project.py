...
from modules.models import (
    Project, Material, MaterialOrder, HistoryLog, SportsModule, Contact, Contract, ContractItem, ContractBarcode,
    ...
    with get_db() as db:
        ...
        if request.method == 'POST':
            ...
            if action == 'sync_material_orders':
                ...
                order_id = safe_int(request.form.get('material_order_id'))
    ...
    with get_db() as db:
        ...
        if request.method == 'POST':
            ...
            # 💡 품목 수정 로그 (기존 ➡️ 변경)
                ...
                mat = db.query(Material).get(safe_int(request.form.get('material_id')))
                if mat:
            ...
            # 💡 계약 품목 바코드 단건 삭제
                ...
                barcode_id = safe_int(request.form.get('barcode_id'))
            ...
            # 💡 담당자 수정
                ...
                con = db.query(Contact).get(safe_int(request.form.get('contact_id')))
                if con:
