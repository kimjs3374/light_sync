    ...
    <div className="sched-wrap">
      ...
      <div className="sched-body rcpt-body">
        <p className="rcpt-note">
          보내신 메일에 <b>눈에 보이지 않는 작은 그림</b>을 하나 넣어 두고,
          받으신 분이 메일을 열어 그 그림을 불러 가면 「읽음」으로 표시합니다.
          <br />
          <b>그림을 막아 둔 메일 프로그램에서는 읽으셔도 「안 읽음」으로 남습니다</b> —
          아웃룩이나 회사 메일에서는 기본으로 막아 두는 곳이 많습니다.
          그러니 안 읽음으로 보인다고 해서 정말 안 보신 것은 아닙니다.
          <br />
          최근에 보내신 메일 100통까지 보여 드립니다.
        </p>
