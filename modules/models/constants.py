...
CONTRACT_ITEM_SPEC_SCHEMA = {
    ...
    "태양광가로등": {
        # 차장님 확인 (2026-05-14): 태양광가로등은 별도 협의항목 없음.
        # 카테고리 자체는 spec_schema 에 등록해서 unknown 으로 떨어지지 않게 하고,
        # required 비워 협의관리 화면에 협의항목 0개로 정상 표시.
        "required": [],
    },
    "가로등주부속자재": {
        # 부속자재 — 베이스커버/암대/플랜지 등 보조부품류 (MTPS-701~708).
        # 협의항목은 별도 정의된 게 없어 일단 빈 required 로 등록.
        # 추후 차장님이 협의 필드 정의해주시면 추가.
        "required": [],
    },
    "LED경관조명기구": {
        # 경관조명 — 일단 빈 required 로 등록.
        # 추후 차장님이 협의 필드 정의해주시면 추가.
        "required": [],
    },
}
